                  ...
                  <ul className="list-none mt-6">
                    <li className="inline">
                      <a
                        ...
                        target="_blank"
                        className="h-8 w-8 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center border-gray-800 rounded-md border hover:border-indigo-600 dark:hover:border-indigo-600 hover:bg-indigo-600 dark:hover:bg-indigo-600"
                      >
                        <i
                    ...
                    <div className="md:col-span-4">
                      <ul className="list-none footer-list mt-6">
                        <li>
                          ...
                          >
                            <i className="uil uil-angle-right-b"></i> Men
                          </a>
                        </li>
                        <li className="mt-[10px]">
                          <a
                            ...
                            className="text-gray-300 hover:text-gray-400 duration-500 ease-in-out"
                          >
                            <i className="uil uil-angle-right-b"></i> Jackets &
                            Coats
                          </a>
                        </li>
                        <li className="mt-[10px]">
                          <a
                            ...
                            className="text-gray-300 hover:text-gray-400 duration-500 ease-in-out"
                          >
                            <i className="uil uil-angle-right-b"></i> Jeans
                          </a>
                        </li>
                        <li className="mt-[10px]">
                          <a
                        ...
                        <li className="mt-[10px]">
                          <a
                            ...
                            className="text-gray-300 hover:text-gray-400 duration-500 ease-in-out"
                          >
                            <i className="uil uil-angle-right-b"></i> Polo
                            shirts
                          </a>
                        </li>
                        <li className="mt-[10px]">
                          <a
                            ...
                            className="text-gray-300 hover:text-gray-400 duration-500 ease-in-out"
                          >
                            <i className="uil uil-angle-right-b"></i> Shirts
                          </a>
                        </li>
                      </ul>
                    </div>
                      ...
                      <ul className="list-none footer-list mt-6">
                        <li>
                          <a
                            ...
                            className="text-gray-300 hover:text-gray-400 duration-500 ease-in-out"
                          >
                            <i className="uil uil-angle-right-b"></i> Shorts
                          </a>
                        </li>
                        <li className="mt-[10px]">
                          <a
                            ...
                            className="text-gray-300 hover:text-gray-400 duration-500 ease-in-out"
                          >
                            <i className="uil uil-angle-right-b"></i> Suits
                            Swimwear
                          </a>
                        </li>
                        <li className="mt-[10px]">
                          <a
                            ...
                            className="text-gray-300 hover:text-gray-400 duration-500 ease-in-out"
                          >
                            <i className="uil uil-angle-right-b"></i> T-shirts
                          </a>
                        </li>
                        <li className="mt-[10px]">
                          <a
                      ...
                      <ul className="list-none footer-list mt-6">
                        <li>
                          <a
                            ...
                            className="text-gray-300 hover:text-gray-400 duration-500 ease-in-out"
                          >
                            <i className="uil uil-angle-right-b"></i> My account
                          </a>
                        </li>
                        <li className="mt-[10px]">
                          <a
                            ...
                            className="text-gray-300 hover:text-gray-400 duration-500 ease-in-out"
                          >
                            <i className="uil uil-angle-right-b"></i> Order
                            History
                          </a>
                        </li>
                        <li className="mt-[10px]">
                          <a
                            ...
                            className="text-gray-300 hover:text-gray-400 duration-500 ease-in-out"
                          >
                            <i className="uil uil-angle-right-b"></i> Wish List
                          </a>
                        </li>
                        <li className="mt-[10px]">
                          <a
          ...
          <div className="py-[30px] px-0 border-t border-slate-800">
            <div className="grid lg:grid-cols-4 md:grid-cols-2">
              <div className="flex items-center lg:justify-center">
                <i className="uil uil-truck align-middle text-lg mb-0 me-2"></i>
                <h6 className="mb-0 font-medium">Free delivery</h6>
              </div>

              <div className="flex items-center lg:justify-center">
                <i className="uil uil-archive align-middle text-lg mb-0 me-2"></i>
                <h6 className="mb-0 font-medium">Non-contact shipping</h6>
              </div>

              <div className="flex items-center lg:justify-center">
                <i className="uil uil-transaction align-middle text-lg mb-0 me-2"></i>
                <h6 className="mb-0 font-medium">Money-back quarantee</h6>
              </div>

              <div className="flex items-center lg:justify-center">
                <i className="uil uil-shield-check align-middle text-lg mb-0 me-2"></i>
