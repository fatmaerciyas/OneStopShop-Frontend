...
export default function Header() {
  ...
  // const itemCount = cart?.items.reduce((sum, item) => sum + item.quantity, 0); //reduce --> get this quantity value
  // console.log({ itemCount }); // it's going to be the quantity of items in the cart
  return (
    <>
      <nav
        id="topnav"
        ...
        <div className="container relative">
          ...
          <ul className="buy-button list-none mb-0">
            <li className="dropdown inline-block relative me-1">
              ...
              <div
                className="dropdown-menu absolute overflow-hidden end-0 m-0 mt-4 z-10 w-52 rounded-md bg-white dark:bg-slate-900 shadow dark:shadow-gray-800 hidden"
            ...
            <li className="dropdown inline-block relative">
              ...
              <div
                className="dropdown-menu absolute end-0 m-0 mt-4 z-10 w-60 rounded-md bg-white dark:bg-slate-900 shadow dark:shadow-gray-800 hidden"
                onClick="event.stopPropagation();"
              >
                <ul
            ...
            <li className="dropdown inline-block relative">
              ...
              <div
                className="dropdown-menu absolute end-0 m-0 mt-4 z-10 w-44 rounded-md bg-white dark:bg-slate-900 shadow dark:shadow-gray-800 hidden"
                onClick="event.stopPropagation();"
              >
                <ul
